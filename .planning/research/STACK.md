...
**Project:** Dev Journal (Next.js personal developer journal)
**Researched:** 2026-05-21
**Overall confidence:** HIGH — all recommendations verified against current docs and npm registry
...
**Use better-sqlite3 + Drizzle ORM.**
...
**Use FTS5 virtual table, not LIKE queries or client-side filtering.**
...
**Use Server Actions for all CRUD.**
...
**Use Tailwind CSS v4 + shadcn/ui, not Chakra UI, MUI, or Mantine.**
...
```bash
# Create project
npx create-next-app@latest dev-journal --typescript --tailwind --app --src-dir
...
```typescript
// lib/db.ts — Database singleton for Server Actions
